    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-gray-900 font-bold">筋トレメモ</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <PersonalRecords records={personalRecords} loading={loading} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-blue-50 p-6 rounded-lg">
                    ...
                    <p className="text-blue-600">
                      {frequency?.total ?? workouts.length}回
                    </p>
                  </div>
                  <div className="bg-green-50 p-6 rounded-lg">
                    <p className="text-gray-600 mb-2">今月のトレーニング</p>
                    <p className="text-green-600">
                      {frequency?.this_month ?? 0}回
                    </p>
                  </div>
                  <div className="bg-purple-50 p-6 rounded-lg">
                    <p className="text-gray-600 mb-2">週平均回数</p>
                    <p className="text-purple-600">
                      {frequency?.average_per_week ?? 0}回
                    </p>
                  </div>
                </div>
              </div>
